...
export function TechnologySection() {
  return (
    <section id="tecnologia" className="overflow-hidden bg-moss py-20 text-white md:py-28">
      <div className="section-shell grid items-center gap-14 lg:grid-cols-12 lg:gap-14">
        <div className="lg:col-span-5">
          <p className="text-sm font-bold uppercase text-[#ddb98c]">Portal do Morador • Tecnologia CondoNow</p>
          ...
          <div className="mt-8 grid grid-cols-2 gap-x-5 gap-y-4 border-y border-white/15 py-6">
            {features.map((feature) => (
              <div key={feature} className="flex items-center gap-3 text-sm font-semibold">
                <Check size={17} className="shrink-0 text-[#ddb98c]" aria-hidden="true" />
                {feature}
              </div>
            ))}
          </div>
        ...
        <div className="relative min-h-[400px] border-b border-white/20 sm:min-h-[600px] lg:col-span-7" aria-label="Telas oficiais do CondoNow">
          <div className="absolute bottom-0 left-[8%] z-20 aspect-[9/16] w-[48%] max-w-[285px] overflow-hidden rounded-[1.35rem] border-[6px] border-[#17231f] bg-white shadow-[0_24px_50px_rgba(0,0,0,0.24)] sm:left-[14%] sm:w-[43%]">
            <Image
              src={condoNowMedia[0].src}
              alt={condoNowMedia[0].alt}
              width={380}
              height={675}
          ...
          <div className="absolute bottom-0 right-[7%] z-10 aspect-[9/16] w-[42%] max-w-[245px] overflow-hidden rounded-[1.2rem] border-[6px] border-[#17231f] bg-white opacity-90 shadow-[0_18px_38px_rgba(0,0,0,0.18)] sm:right-[13%] sm:w-[37%]">
            <Image
              src={condoNowMedia[3].src}
              alt={condoNowMedia[3].alt}
              width={380}
              height={675}
